...
with st.sidebar:
    ...
    if choice == "File":
        file = st.file_uploader("Upload .docx, .txt or .pdf file", type=["pdf", "txt", "docx"])
        if file:
...
if not docs:
    st.markdown("""
        Welcome!
        make a quiz from Wikipedia articles or files you upload
        Upload your files or search on Wikipedia in the sidebar.
    """)
else:
